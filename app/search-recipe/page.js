        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-10 max-w-4xl mx-auto space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-pink-300 transition"
            />
          </div>
